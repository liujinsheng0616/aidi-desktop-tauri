...
import DiskClean from './optimizer/DiskClean.vue'
import MemoryStatus from './optimizer/MemoryStatus.vue'
import StartupManager from './optimizer/StartupManager.vue'
